...
void OpenGLES_005_Camera::resetSetting(int index)
{
...
void OpenGLES_005_Camera::changeModel(int index)
{
    //0> setting
    resetSetting(index);
...
void OpenGLES_005_Camera::loadModel_Default()
{
    FMeshData meshData;
    ...
    {
        F_LogError("*********************** OpenGLES_005_Camera::loadModel_Default load model failed: [%s] !", this->cfg_model_Path.c_str());
        return;
    }
...
void OpenGLES_005_Camera::buildObjectCB()
{
    ObjectConstants objectConstants;
    this->objectCBs.push_back(objectConstants);
}

bool OpenGLES_005_Camera::beginRenderImgui()
{
    ImGui_ImplOpenGL3_NewFrame();
    ImGui_ImplAndroid_NewFrame();
    ImGui::NewFrame();
    static bool windowOpened = true;
    ImGui::Begin("OpenGLES_005_Camera", &windowOpened, 0);
    {
        //0> Common
        commonConfig();
    ...
    void OpenGLES_005_Camera::modelConfig()
    {
...
void OpenGLES_005_Camera::endRenderImgui()
{
