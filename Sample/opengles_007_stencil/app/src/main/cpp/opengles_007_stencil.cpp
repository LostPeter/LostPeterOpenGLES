	...
	, pShaderFragment_Outline(nullptr)
{
    ...
    this->shaderVertex_Path = getShaderPathRelative("pos3_color4_normal3_tex2_ubo.vert.spv");
    this->shaderFragment_Path = getShaderPathRelative("pos3_color4_normal3_tex2_ubo.frag.spv");
...
void OpenGLES_007_Stencil::createCamera()
{
...
void OpenGLES_007_Stencil::loadModel_Custom()
{
    for (int i = 0; i < g_CountLen; i++)
    {
        ...
        {
            String msg = "*********************** OpenGLES_007_Stencil::loadModel_Custom: Failed to load model: " + pModelObject->pathModel;
        ...
        {   
            String msg = "*********************** OpenGLES_007_Stencil::loadModel_Custom: Failed to load texture: " + pModelObject->pathTexture;
            F_LogError("%s", msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
...
bool OpenGLES_007_Stencil::loadModel_VertexIndex(ModelObject* pModelObject, bool isFlipY, bool isTransformLocal, const FMatrix4& matTransformLocal)
{
    //1> Load 
    FMeshData meshData;
    ...
    {
        F_LogError("*********************** OpenGLES_007_Stencil::loadModel_VertexIndex load model failed: [%s] !", pModelObject->pathModel.c_str());
        return false; 
    }
    ...
    F_LogInfo("OpenGLES_007_Stencil::loadModel_VertexIndex: load model [%s] success, Vertex count: [%d], Index count: [%d] !", 
		...
		pModelObject->poIndexBuffer_Data != nullptr)
	{
		...
		{
			F_LogError("*********************** OpenGLES_007_Stencil::loadModel_VertexIndex: create buffer vertex index failed: [%s] !", pModelObject->nameModel.c_str());
			return false;
		}
	}
	else
	{
		...
		{
			F_LogError("*********************** OpenGLES_007_Stencil::loadModel_VertexIndex: create buffer vertex failed: [%s] !", pModelObject->nameModel.c_str());
			return false;
		}
	}
...
bool OpenGLES_007_Stencil::loadModel_Texture(ModelObject* pModelObject)
{
    if (!pModelObject->pathTexture.empty())
    {
        ...
        F_LogInfo("OpenGLES_007_Stencil::loadModel_Texture: Load texture [%s] success !", pModelObject->pathTexture.c_str());
    }

    return true;
}

void OpenGLES_007_Stencil::createCustomCB()
{
    ...
    for (size_t i = 0; i < count; i++)
    {
		...
		{
			String msg = "*********************** OpenGLES_007_Stencil::createCustomCB: create buffer uniform: [" + nameBuffer + "] failed !";
			F_LogError("%s", msg.c_str());
...
void OpenGLES_007_Stencil::createGraphicsPipeline_Custom()
{
    String namePathBase;
	...
	{
		String msg = "*********************** OpenGLES_007_Stencil::createGraphicsPipeline_Custom: Failed to create shader vertex: " + this->shaderVertex_Path;
		F_LogError("%s", msg.c_str());
		throw std::runtime_error(msg);
	}
	...
	{
		String msg = "*********************** OpenGLES_007_Stencil::createGraphicsPipeline_Custom: Failed to create shader fragment: " + this->shaderFragment_Path;
		F_LogError("%s", msg.c_str());
		throw std::runtime_error(msg);
	}
	...
	{
		String msg = "*********************** OpenGLES_007_Stencil::createGraphicsPipeline_Custom: Failed to create shader vertex: " + this->shaderVertex_Path_Outline;
		F_LogError("%s", msg.c_str());
		throw std::runtime_error(msg);
	}
	...
	{
		String msg = "*********************** OpenGLES_007_Stencil::createGraphicsPipeline_Custom: Failed to create shader fragment: " + this->shaderFragment_Path_Outline;
		F_LogError("%s", msg.c_str());
		throw std::runtime_error(msg);
	}
    ...
    for (size_t i = 0; i < count; i++)
    {
        ...
        {
            String msg = "*********************** OpenGLES_007_Stencil::createGraphicsPipeline_Custom: Failed to create pipeline stencil !";
            F_LogError("%s", msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
        ...
        {
            String msg = "*********************** OpenGLES_007_Stencil::createGraphicsPipeline_Custom: Failed to create pipeline outline !";
            F_LogError("%s", msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
...
void OpenGLES_007_Stencil::createDescriptorSets_Custom()
{
    size_t count = this->m_aModelObjects.size();
    for (size_t i = 0; i < count; i++)
    {
...
void OpenGLES_007_Stencil::updateCBs_Custom()
{
...
bool OpenGLES_007_Stencil::beginRenderImgui()
{
	ImGui_ImplOpenGL3_NewFrame();
    ImGui_ImplAndroid_NewFrame();
    ImGui::NewFrame();
    static bool windowOpened = true;
    ImGui::Begin("OpenGLES_007_Stencil", &windowOpened, 0);
    {
        //0> Common
        commonConfig();
...
void OpenGLES_007_Stencil::modelConfig()
{
...
void OpenGLES_007_Stencil::endRenderImgui()
{
    OpenGLESWindow::endRenderImgui();

}

void OpenGLES_007_Stencil::drawMeshDefault_Custom()
{   
