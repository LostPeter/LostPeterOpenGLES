...
#ifndef _OPENGLES_008_BLEND_H_
#define _OPENGLES_008_BLEND_H_

#include "OpenGLESWindow.h"
using namespace LostPeterOpenGLES; 

class OpenGLES_008_Blend : public OpenGLESWindow
{
public:
    OpenGLES_008_Blend(String name);

public:
	struct ModelObject
	{
		ModelObject(OpenGLES_008_Blend* _pWindow)
			//Common
			: pWindow(_pWindow)
