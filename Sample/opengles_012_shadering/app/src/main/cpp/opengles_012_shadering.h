...
class OpenGLES_012_Shadering : public OpenGLESWindow
{
public:
    OpenGLES_012_Shadering(String name);

public:
	/////////////////////////// ModelMesh ///////////////////////////
    struct ModelMesh
    {
        OpenGLES_012_Shadering* pWindow;
        String nameMesh;
        String pathMesh;
        FMeshType typeMesh;
        ...
        ModelMesh(OpenGLES_012_Shadering* _pWindow, 
	...
	struct ModelObject
	{
		ModelObject(OpenGLES_012_Shadering* _pWindow)
			//Common
			: pWindow(_pWindow)
