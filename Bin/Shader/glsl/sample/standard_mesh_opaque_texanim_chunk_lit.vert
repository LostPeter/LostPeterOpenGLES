...
void main()
{
    ...
    fragWorldPos.w = float(gl_InstanceID);
    fragColor = inColor;
    mat3 normalMatrix = transpose(inverse(mat3(obj.g_MatWorld)));
	fragWorldNormal = normalize(normalMatrix * inNormal);
	fragTexCoord = vec2((inTexCoord.x + mat.aTexLayers[0].texChunk.z) / mat.aTexLayers[0].texChunk.x, (inTexCoord.y + mat.aTexLayers[0].texChunk.w) / mat.aTexLayers[0].texChunk.y);
}