...
{
    class foundationExport FCapsule
	{
	public:
		F_FORCEINLINE FCapsule()
			: m_vCenterTop(0, 1, 0)
		...
		F_FORCEINLINE FCapsule(const FVector3& vCenterTop, const FVector3& vCenterBottom, float fRadius)
		...
		F_FORCEINLINE FCapsule(const FCapsule& capsule) 
