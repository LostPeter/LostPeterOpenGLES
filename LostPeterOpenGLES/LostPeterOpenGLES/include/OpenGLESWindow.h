        ...
        virtual void loadAssets();
            ...
            virtual void loadGeometry();
                ...
                virtual void loadTexture();
                    ...
                    virtual bool createTexture2DArray(const String& nameTexture,
					...
					virtual bool createTexture3D(const String& nameTexture,
                                                 const String& pathAsset_Tex,
                                                 int& mipMapCount, 
                                                 bool isAutoMipmap,
                                                 FTextureType typeTexture, 
					...
					virtual bool createTextureCubeMap(const String& nameTexture,
													  const StringVector& aPathAsset_Tex, 
													  int& mipMapCount, 
													  bool isAutoMipmap,
													  FTextureType typeTexture, 
                    ...
                    virtual bool createTextureRenderTarget2DArray(const String& nameTexture,
                                                                  const FVector4& clDefault,
                                                                  bool isSetColor,
                                                                  int channel,
                                                                  int width, 
					...
					virtual bool createTextureRenderTarget3D(const String& nameTexture,
															 const FVector4& clDefault,
															 bool isSetColor,
															 int channel,
															 int width, 
					...
					virtual bool createTextureRenderTargetCubeMap(const String& nameTexture,
																  const FVector4& clDefault,
																  bool isSetColor,
																  int channel,
																  int width, 
